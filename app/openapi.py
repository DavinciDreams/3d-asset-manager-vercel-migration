            ...
            'schemas': {
                ...
                'LodVariant': {
                    ...
                    'properties': {
                        ...
                        'settings': {
                            'type': 'object',
                            'description': 'LOD generation settings and runtime cost metadata. LOD1 targets mid/fill use with target_vertices=20000; LOD2 is aggressively simplified for far/large-fill use with target_vertices=10000; LOD3 is an original-source ultra-far flat silhouette target generated by simplifying first, then flattening material.',
                        },
                        'mesh_stats': {'$ref': '#/components/schemas/MeshStats'},
