            ...
            'schemas': {
                ...
                'LodVariant': {
                    ...
                    'properties': {
                        ...
                        'settings': {
                            'type': 'object',
                            'description': 'LOD generation settings and runtime cost metadata. LOD1 targets mid/fill use with target_vertices=20000; LOD2 keeps a lighter far/large-fill mesh while preserving UV/material readability for visible world placement; LOD3 is an ultra-far textured proxy with the smallest geometry budget. The impostor variant remains the preferred true far-distance representation.',
                        },
                        'mesh_stats': {'$ref': '#/components/schemas/MeshStats'},
