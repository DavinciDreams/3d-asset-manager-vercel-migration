...
def _model_summary_schema():
    return {
        ...
        'properties': {
            ...
            'lod_ready': {
                'type': 'boolean',
                'description': 'True only when LOD0, LOD1, and LOD2 are all present.',
            },
            'lod_status': {
                'type': 'string',
            ...
            'schemas': {
                ...
                'LodSummary': {
                    ...
                    'properties': {
                        ...
                        'missing_levels': {'type': 'array', 'items': {'type': 'integer', 'enum': [0, 1, 2]}},
                        'levels': {'type': 'array', 'items': {'$ref': '#/components/schemas/LodVariant'}},
                        'cheapest_level': {'type': 'integer', 'nullable': True, 'enum': [0, 1, 2, None]},
