...
models = Table(
    ...
    Column("media_capture", _json_type(), nullable=False, default=dict),
...
def _ensure_model_columns(engine):
    ...
    desired = {
        ...
        "media_capture": "JSONB NOT NULL DEFAULT '{}'::jsonb" if engine.dialect.name == "postgresql" else "JSON DEFAULT '{}' NOT NULL",
